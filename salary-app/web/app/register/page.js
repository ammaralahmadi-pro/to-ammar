...
export default function RegisterPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      setError(err.message === 'request_failed_409' ? 'البريد الإلكتروني مستخدم مسبقًا' : 'تعذّر إنشاء الحساب');
    } finally {
      setLoading(false);
    }
  }
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-muted px-4">
      <div className="w-full max-w-sm bg-surface shadow-card rounded-2xl p-8">
        <h1 className="font-display font-extrabold text-2xl text-primary mb-1">إنشاء حساب</h1>
        <p className="text-gray-500 text-sm mb-6">ابدأ بتنظيم راتبك الشهري في دقيقة</p>
