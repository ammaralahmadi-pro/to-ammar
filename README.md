...
## إعداد مزامنة المهام بين جهازين (اختياري)

المهام بشكل افتراضي مخزّنة محليًا في متصفح كل جهاز لوحده. عشان تظهر نفس المهام على جوالك التاني أول بأول، محتاج قاعدة بيانات سحابية بسيطة ومجانية (Firebase Firestore):
...
من هذه اللحظة، أي مهمة تضيفها أو تعدّلها في أي جهاز تظهر تلقائيًا في الجهاز التاني.
...
js/sync.js           مزامنة المهام بين جهازين عبر Firebase Firestore (اختياري)
